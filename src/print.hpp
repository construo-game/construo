...
#ifndef HEADER_CONSTRUO_PRINT_HPP
#define HEADER_CONSTRUO_PRINT_HPP
...
// std::format + fwrite polyfill (R36S / older libstdc++, MinGW, etc.).
// Pattern adapted from Pingus src/util/print.hpp.
#if defined(__cpp_lib_print) && __cpp_lib_print >= 202207L && !defined(_WIN32)
#  include <print>
#  define CONSTRUO_HAS_STD_PRINT 1
#else
#  define CONSTRUO_HAS_STD_PRINT 0
#endif

namespace construo {

#if CONSTRUO_HAS_STD_PRINT
