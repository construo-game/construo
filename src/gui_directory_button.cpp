...
GUIDirectoryButton::draw (GraphicContext* parent_gc)
{
  ...
  parent_gc->draw_string (static_cast<float>(m_x + 40), static_cast<float>(m_y + 20), "..:: Directory ::..");
  parent_gc->draw_string (static_cast<float>(m_x + 30), static_cast<float>(m_y + 40), m_filename);
